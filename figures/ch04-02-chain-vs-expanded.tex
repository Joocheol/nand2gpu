...
\begin{tikzpicture}[diagram]
  ...
  % gate:expanded-or
  \node[gate,minimum width=20mm,minimum height=9mm] (e-u0) at (5.25,6.08)
    {\(U_0\)\\\((T_0{=}g_3)\lor T_1\)};
  % gate:expanded-and
  ...
  % gate:expanded-or
  \node[path gate,minimum width=17mm,minimum height=9mm] (e-u1) at (7.35,4.85)
    {\(U_1\)\\\(T_2\lor T_3\)};
  % gate:expanded-and
  ...
  % gate:expanded-or
  \node[path gate,minimum width=17mm,minimum height=9mm] (e-u2) at (9.45,4.85)
    {\(U_2\)\\\(U_0\lor U_1\)};
  % gate:expanded-or
  \node[path gate,minimum width=17mm,minimum height=9mm] (e-c4) at (11.55,4.85)
    {\(c_4\)\\\(U_2\lor T_4\)};
