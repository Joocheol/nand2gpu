...
\begin{tikzpicture}[diagram]
  ...
  % adder:carry-example
  \node[concept box,minimum width=26mm,minimum height=22mm] (fa3) at (1.70,3.95)
    {\textbf{자리 3}\\[1mm]\(p_3=1\)\\들어온 올림을 전달};
  % adder:carry-example
  \node[concept box,minimum width=26mm,minimum height=22mm] (fa2) at (4.90,3.95)
    {\textbf{자리 2}\\[1mm]\(p_2=1\)\\들어온 올림을 전달};
  % adder:carry-example
  \node[concept box,minimum width=26mm,minimum height=22mm] (fa1) at (8.10,3.95)
    {\textbf{자리 1}\\[1mm]\(p_1=1\)\\들어온 올림을 전달};
  % adder:carry-example
  \node[concept emphasis,minimum width=26mm,minimum height=22mm] (fa0) at (11.30,3.95)
    {\textbf{자리 0}\\[1mm]\(g_0=1\)\\새 올림을 생성};
