...
\begin{tikzpicture}[diagram]
  ...
  \node[gate,minimum width=9mm] (na) at (0.69,5.80) {$N_A$};
  \node[gate,minimum width=9mm] (nb) at (0.69,4.64) {$N_B$};
  \node[gate,minimum width=9mm] (n)  at (0.69,3.48) {$N$};
  \node[path gate,minimum width=9mm] (o) at (1.69,5.22) {$O$};
  \node[path gate,minimum width=9mm] (t) at (2.69,4.64) {$T$};
  \node[path gate,minimum width=9mm] (ya) at (3.69,4.64) {$Y$};
  \draw[path wire] (na.east) -- (o.north west);
  \draw[path wire] (nb.east) -- (o.south west);
  \draw[path wire] (o.east) -- (t.north west);
  \draw[path wire] (n.east) -- (t.south west);
  \draw[path wire] (t.east) -- (ya.west);
  ...
  \node[gate,minimum width=11mm] (n1) at (9.55,4.64) {$N_1$};
  \node[path gate,minimum width=11mm] (n2) at (10.80,5.28) {$N_2$};
  \node[path gate,minimum width=11mm] (n3) at (10.80,4.00) {$N_3$};
  \node[path gate,minimum width=11mm] (yb) at (12.05,4.64) {$Y$};
  \draw[path wire] (n1.east) -- (n2.west);
  \draw[path wire] (n1.east) -- (n3.west);
  \draw[path wire] (n2.east) -- (yb.north west);
  \draw[path wire] (n3.east) -- (yb.south west);
