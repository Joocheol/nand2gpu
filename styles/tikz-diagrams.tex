...
\tikzset{
  ...
  concept box/.style={
    draw=black!68,fill=white,line width=0.55pt,rounded corners=1.2mm,
    minimum height=8mm,inner xsep=2mm,inner ysep=1.2mm,
    align=center,font=\DiagramBodyFont
  },
  concept emphasis/.style={concept box,fill=black!12,draw=black,line width=0.8pt},
  concept arrow/.style={draw=black!68,line width=0.65pt,-{Stealth[length=1.8mm,width=1.25mm]}},
  concept dashed arrow/.style={draw=black!58,line width=0.55pt,densely dashed,
