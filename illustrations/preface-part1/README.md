...
이 SVG 12종은 내용과 배치를 빠르게 검토하기 위한 참고본으로 유지한다. 최종 제작 원본은 `figures/`의 TikZ 그림으로 옮기고, TeX 본문과 같은 글꼴·수식·선 굵기·회색 정의를 공유한다.
...
- `ch04-02`는 첫 시험 이식을 마쳤다. B5 가로 전면 폭에서 최소 6.5pt, 리플 16게이트·9층, 펼친 식 22게이트·6층을 검증했으며 이후에는 `figures/ch04-02-chain-vs-expanded.tex`만 제작 원본으로 수정한다.
